...
define dso_local void @print(i8* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) %0)
  ret void
}
...
define dso_local i32 @getInt() local_unnamed_addr #2 {
  ...
  %3 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* nonnull %1) #6
